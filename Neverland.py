...
myAgeNevLand = int(input())
numbYearSinceLeft = int(input())

twinAge = myAgeNevLand + numbYearSinceLeft 
difference = twinAge - myAgeNevLand 


print(f"My twin is {twinAge} years old and they are {difference} years older than me")
